...
```markdown
![Desktop View](/assets/img/test.png){: width="700" height="400" }
```
{: .nolineno}
...
```markdown
![Desktop View](/assets/img/test.png){: w="700" h="400" }
```
{: .nolineno}
...
- **Normal position**
  ...
  ```markdown
  ![Desktop View](/assets/img/test.png){: .normal }
  ```
  {: .nolineno}
...
- **Float to the left**
  ...
  ```markdown
  ![Desktop View](/assets/img/test.png){: .left }
  ```
  {: .nolineno}
...
- **Float to the right**
  ...
  ```markdown
  ![Desktop View](/assets/img/test.png){: .right }
  ```
  {: .nolineno}
...
```markdown
![Desktop View](/assets/img/test.png){: .shadow }
```
{: .nolineno}
